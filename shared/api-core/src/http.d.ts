...
export declare const BODY_TOO_LARGE_FLAG = "_bodyTooLarge";
export declare const BODY_INVALID_JSON_FLAG = "_bodyInvalidJson";
export declare function readJsonBody(req: http.IncomingMessage, maxBytes?: number): Promise<any>;
...
export declare function payloadTooLarge(res: http.ServerResponse, message?: string): void;
