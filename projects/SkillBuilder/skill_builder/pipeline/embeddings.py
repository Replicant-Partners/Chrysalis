...
# Go up from: projects/SkillBuilder/skill_builder/pipeline/embeddings.py
# To: Chrysalis/shared/
# Path structure: Chrysalis/projects/SkillBuilder/skill_builder/pipeline/embeddings.py
# parents[0] = pipeline, [1] = skill_builder, [2] = SkillBuilder, [3] = projects, [4] = Chrysalis
...
try:
    ...
    class EmbeddingService(_EmbeddingService):
        ...
        with existing SkillBuilder code. All functionality is delegated to the
