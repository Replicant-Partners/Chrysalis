/**
 * Universal Adapter Prompts v2.0
 *
...
import { SemanticHints, ProtocolEntryV2, MinimalSchema } from './registry-v2';
 ...
 */
export function buildTranslationPromptV2(
  agent: Record<string, unknown>,
  sourceProtocol: string,
  targetProtocol: string,
  sourceEntry: ProtocolEntryV2,
  targetEntry: ProtocolEntryV2,
  sourceSpec?: string,
  targetSpec?: string
): string {
 ...
 */
export function buildValidationPromptV2(
  agent: Record<string, unknown>,
  protocolEntry: ProtocolEntryV2,
  spec?: string
): string {
 ...
 */
export function buildCapabilityDiscoveryPromptV2(
  protocolEntry: ProtocolEntryV2,
  spec?: string
): string {
  const schema = spec || JSON.stringify(protocolEntry.fallbackSchema, null, 2);
 ...
 */
export function buildFieldMappingPromptV2(
  sourceEntry: ProtocolEntryV2,
  targetEntry: ProtocolEntryV2,
  sourceSpec?: string,
  targetSpec?: string
